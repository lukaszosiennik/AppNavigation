#
# Be sure to run `pod lib lint AppNavigation.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'AppNavigation'
  s.version          = '0.1.0'
  s.summary          = 'A short description of AppNavigation.'
...
TODO: Add long description of the pod here.
  ...
  # s.resource_bundles = {
  #   'AppNavigation' => ['AppNavigation/Assets/*.png']
  # }
