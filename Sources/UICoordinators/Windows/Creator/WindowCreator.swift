...
public struct WindowCreator<DevRootWindowType> where DevRootWindowType: DevRootWindowTypeInterface {
    ...
    public init(entity: WindowEntity<DevRootWindowType>, createViewController: @autoclosure @escaping ViewController.Create) {
        self.init(entity: entity, createWindow: Window.default(for: entity.type), createViewController: createViewController())
    }
    
    public init(entity: WindowEntity<DevRootWindowType>, createWindow: @escaping Window.Create, createViewController: @autoclosure @escaping ViewController.Create) {
        self.entity = entity
